...
export const UNIT_CATEGORIES: UnitCategory[] = [
  {
    ...
    units: [
      ...
      {
        id: 'lb',
        name: { en: 'Pound', pl: 'Funt' },
        symbol: 'lb',
        factor: 0.45359237,
        keywords: ['funty', 'lbs', 'pounds'],
      },
      {
        id: 'oz',
        name: { en: 'Ounce', pl: 'Uncja' },
        symbol: 'oz',
        factor: 0.028349523125,
        keywords: ['uncje', 'ounces'],
      },
      {
        id: 'st',
        name: { en: 'Stone', pl: 'Kamień' },
        symbol: 'st',
        factor: 6.35029318,
        keywords: ['kamienie', 'stones'],
      },
    ],
  },
  {
    ...
    units: [
      ...
      {
        id: 'nm',
        name: { en: 'Nautical Mile', pl: 'Mila morska' },
        symbol: 'NM',
        factor: 1852,
        keywords: ['mila morska', 'nautical miles'],
      },
    ],
  },
  {
    ...
    units: [
      ...
      {
        id: 'cup_pl',
        name: { en: 'Glass (250 ml)', pl: 'Szklanka (250 ml)' },
        symbol: 'szklanka',
        factor: 250,
        keywords: ['szklanki', 'kubek'],
      },
      {
        id: 'cup_us',
        name: { en: 'US Cup (240 ml)', pl: 'US Cup (240 ml)' },
        symbol: 'cup',
        factor: 236.5882365,
        keywords: ['cups', 'amerykanska'],
      },
      {
        id: 'tbsp',
        name: { en: 'Tablespoon (15 ml)', pl: 'Łyżka stołowa (15 ml)' },
        symbol: 'tbsp',
        factor: 15,
        keywords: ['lyzka', 'lyzki', 'tablespoon'],
      },
      {
        id: 'tsp',
        name: { en: 'Teaspoon (5 ml)', pl: 'Łyżeczka (5 ml)' },
        symbol: 'tsp',
        factor: 5,
        keywords: ['lyzeczka', 'lyzeczki', 'teaspoon'],
      },
      {
        id: 'fl_oz',
        name: { en: 'US Fluid Ounce', pl: 'Uncja płynu (US)' },
        symbol: 'fl oz',
        factor: 29.5735296,
        keywords: ['fluid ounce', 'uncja plynu'],
      },
      {
        id: 'gal_us',
        name: { en: 'US Gallon', pl: 'Galon US' },
        symbol: 'gal (US)',
        factor: 3785.411784,
        keywords: ['galon', 'galony', 'gallon'],
      },
      {
        id: 'pt_us',
        name: { en: 'US Pint', pl: 'Pinta US' },
        symbol: 'pt',
        factor: 473.176473,
        keywords: ['pinta', 'pint'],
      },
  ...
  },
  {
    ...
    units: [
      {
        id: 'kmh',
        name: { en: 'Kilometers per hour', pl: 'Kilometry na godzinę' },
        symbol: 'km/h',
        factor: 1,
        keywords: ['km/h', 'kph'],
      },
      {
        id: 'mph',
        name: { en: 'Miles per hour', pl: 'Mile na godzinę' },
        symbol: 'mph',
        factor: 1.609344,
        keywords: ['mph', 'mile/h'],
      },
      ...
      {
        id: 'ms',
        name: { en: 'Meters per second', pl: 'Metry na sekundę' },
        symbol: 'm/s',
        factor: 3.6,
        keywords: ['m/s'],
      },
      {
        id: 'mach',
        name: { en: 'Mach (at 15°C)', pl: 'Mach (15°C)' },
        symbol: 'Ma',
        factor: 1225.044,
        keywords: ['mach'],
      },
  ...
  },
  {
    ...
    units: [
      ...
      {
        id: 'psi',
        name: { en: 'Pound per Square Inch', pl: 'PSI (funt/cal²)' },
        symbol: 'PSI',
        factor: 0.0689475729,
        keywords: ['psi', 'kola', 'opona'],
      },
      {
        id: 'kpa',
        name: { en: 'Kilopascal', pl: 'Kilopaskal' },
        symbol: 'kPa',
        factor: 0.01,
        keywords: ['kpa', 'paskale'],
      },
      { id: 'mpa', name: { en: 'Megapascal', pl: 'Megapaskal' }, symbol: 'MPa', factor: 10, keywords: ['mpa'] },
      {
        id: 'atm',
        name: { en: 'Standard Atmosphere', pl: 'Atmosfera' },
        symbol: 'atm',
        factor: 1.01325,
        keywords: ['atmosfera'],
      },
      {
        id: 'mmhg',
        name: { en: 'Millimeters of Mercury', pl: 'mmHg (Tor)' },
        symbol: 'mmHg',
        factor: 0.00133322387,
        keywords: ['mmhg', 'cisnienie krwi', 'torr'],
      },
    ],
  },
  {
    ...
    units: [
      {
        id: 'm2',
        name: { en: 'Square Meter', pl: 'Metr kwadratowy' },
        symbol: 'm²',
        factor: 1,
        keywords: ['m2', 'metry kwadratowe', 'mieszkanie'],
      },
      {
        id: 'ha',
        name: { en: 'Hectare', pl: 'Hektar' },
        symbol: 'ha',
        factor: 10000,
        keywords: ['hektary', 'dzialka'],
      },
      { id: 'a', name: { en: 'Are', pl: 'Ar' }, symbol: 'a', factor: 100, keywords: ['ary'] },
      {
        id: 'sq_ft',
        name: { en: 'Square Foot', pl: 'Stopa kwadratowa' },
        symbol: 'sq ft',
        factor: 0.09290304,
        keywords: ['sq ft', 'ft2', 'stopy kwadratowe'],
      },
      {
        id: 'acre',
        name: { en: 'Acre', pl: 'Akr' },
      ...
      {
        id: 'km2',
        name: { en: 'Square Kilometer', pl: 'Kilometr kwadratowy' },
        symbol: 'km²',
        factor: 1000000,
        keywords: ['km2'],
      },
  ...
  },
  {
    ...
    units: [
      ...
      {
        id: 'KB',
        name: { en: 'Kilobyte (1000 B)', pl: 'Kilobajt (1000 B)' },
        symbol: 'KB',
        factor: 1000,
        keywords: ['kb', 'kilobajty'],
      },
      {
        id: 'MB',
        name: { en: 'Megabyte (1000 KB)', pl: 'Megabajt (1000 KB)' },
        symbol: 'MB',
        factor: 1000000,
        keywords: ['mb', 'megabajty'],
      },
      {
        id: 'GB',
        name: { en: 'Gigabyte (1000 MB)', pl: 'Gigabajt (1000 MB)' },
        symbol: 'GB',
        factor: 1000000000,
        keywords: ['gb', 'gigabajty'],
      },
      {
        id: 'TB',
        name: { en: 'Terabyte (1000 GB)', pl: 'Terabajt (1000 GB)' },
        symbol: 'TB',
        factor: 1000000000000,
        keywords: ['tb', 'terabajty'],
      },
      {
        id: 'KiB',
        name: { en: 'Kibibyte (1024 B)', pl: 'Kibibajt (1024 B)' },
        symbol: 'KiB',
        factor: 1024,
        keywords: ['kib'],
      },
      {
        id: 'MiB',
        name: { en: 'Mebibyte (1024 KiB)', pl: 'Mebibajt (1024 KiB)' },
        symbol: 'MiB',
        factor: 1048576,
        keywords: ['mib'],
      },
      {
        id: 'GiB',
        name: { en: 'Gibibyte (1024 MiB)', pl: 'Gibibajt (1024 MiB)' },
        symbol: 'GiB',
        factor: 1073741824,
        keywords: ['gib'],
      },
  ...
  },
  {
    ...
    units: [
      {
        id: 'dec',
        name: { en: 'Decimal (Base 10)', pl: 'Dziesiętny (DEC)' },
        symbol: 'DEC',
        keywords: ['dec', 'dziesietny', '10'],
      },
      {
        id: 'hex',
        name: { en: 'Hexadecimal (Base 16)', pl: 'Szesnastkowy (HEX)' },
        symbol: 'HEX',
        keywords: ['hex', 'szesnastkowy', '16'],
      },
      {
        id: 'bin',
        name: { en: 'Binary (Base 2)', pl: 'Binarny / Dwójkowy (BIN)' },
        symbol: 'BIN',
        keywords: ['bin', 'binarny', 'dwojkowy', '2', '01'],
      },
      {
        id: 'oct',
        name: { en: 'Octal (Base 8)', pl: 'Ósemkowy (OCT)' },
        symbol: 'OCT',
        keywords: ['oct', 'osemkowy', '8'],
      },
      {
        id: 'ascii',
        name: { en: 'ASCII Text', pl: 'Tekst ASCII' },
        symbol: 'ASCII',
        keywords: ['ascii', 'znaki', 'kod'],
      },
    ],
  },
  {
    ...
    units: [
      {
        id: 'ms',
        name: { en: 'Millisecond', pl: 'Milisekunda' },
        symbol: 'ms',
        factor: 0.001,
        keywords: ['milisekundy'],
      },
      ...
      {
        id: 'yr',
        name: { en: 'Year (365d)', pl: 'Rok (365 dni)' },
        symbol: 'yr',
        factor: 31536000,
        keywords: ['lata', 'rok'],
      },
 ...
 */
export function convertValue(value: number, fromUnitId: string, toUnitId: string, category: UnitCategory): number {
 ...
 */
export function convertRadix(rawInput: string, fromUnitId: string, toUnitId: string): string {
